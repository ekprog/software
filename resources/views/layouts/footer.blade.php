    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row text-center text-md-left mt-3 pb-3">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p>we aim to let you to see the world, experience a new culture, make friends from 100 countries – and
                    prepare for your global future. Start any Monday and study from two weeks to a whole year.</p>
            </div>
            <!-- Grid column -->
